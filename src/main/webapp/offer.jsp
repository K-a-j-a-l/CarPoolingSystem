...
<body class="page=top">
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					...
					<li class="nav-item mx-0 mx-lg-1">
					<a class="nav-link active py-3 px-0 px-lg-3 rounded" href="offer.jsp">Offer a ride</a></li>
					<li class="nav-item mx-0 mx-lg-1">
	...
	<section class="page-section mt-5" id="offer">
		<div class="container">
			<!-- Offer Section Heading-->
			<h2
				class="page-section-heading text-center text-uppercase text-secondary mb-0">Offer a ride</h2>
			<!-- Icon Divider-->
			...
			<div class="row justify-content-center">
				<div class="col-lg-8 col-xl-7">
						<form id="searchForm" method="post" action="offer" data-sb-form-api-token="API_TOKEN">
        					...
        					<label for="seats">Available Number of Seats:</label>
        					<input class="form-control"  type="number" min=1 max=4 id="date" name="date" required>
        					<input class="btn mt-2" type="submit" value="Offer Ride">
					</form>
				</div>
			</div>
		</div>
